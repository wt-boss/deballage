        ...
        >
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div>
                    ...
                    <p class="mt-4 max-w-xs text-gray-100">
                        Deballage, is a web app that aims at empowering
                        individuals to effortlessly buy and sell quality
                        clothing and shoes online while fostering a sense of
                        direct and personalized connection
                    </p>
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400">
                &copy; 2023. Deballage. All rights reserved.
            </p>
        </div>
    </footer>
</template>
